...
public abstract class JbpmBpmn2TestCase extends AbstractBaseTest {
    ...
    protected static final Object [] STACKLESS =
                { false, false, true, "STACKLESS"}; // stackless w/o persistence
    protected static final Object [] STACKLESS_PERSISTENCE =
                { true, false, true, "STACKLESS PERSISTENCE" }; // stackless w/ persistence
    protected static final Object [] STACKLESS_PERSISTENCE_LOCKING =
    ...
    public JbpmBpmn2TestCase(boolean sessionPersistance, boolean locking, boolean stackless, String name) {
        ...
        this.queueBasedExecution = stackless;
    }
